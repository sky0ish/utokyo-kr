...
select category as "지금 게시판",
       case
         ...
         when title ~ '생산기술연구소|생기연|선단과학|선단연|RCAST|물성연구소|우주선연구소|지진연구소|대기해양' then '생산·선단과학·기술기타'
...
update public.posts p
   set category = 'major',
       title = '[' || case
         ...
         when t.title ~ '생산기술연구소|생기연|선단과학|선단연|RCAST|물성연구소|우주선연구소|지진연구소|대기해양' then '생산·선단과학·기술기타'
