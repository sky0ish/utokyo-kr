...
export async function initWrite(ORG) {
  ...
  if (!profile || !profile.approved) {
    ...
    // 게시판 분류 · 말머리 선택 (조직별)
    const CATS_OB = { assembly:"총회", free:"자유게시판", club:"소모임", mentoring:"멘토멘티(OB/YB)", forum:"포럼·세미나", promo:"홍보·채용", condolence:"경조사", notice:"공지사항", research:"단행본 및 연구소개", suggest:"동문회에 바란다" };
