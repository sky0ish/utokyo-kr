...
export async function initWrite(ORG) {
  ...
  if (!profile || !profile.approved) {
    ...
    // 게시판 분류 · 말머리 선택 (조직별)
    const CATS_OB = { assembly:"총회", free:"자유게시판", club:"소모임", mentoring:"멘토멘티(OB/YB)", forum:"포럼·세미나", jobs:"구인·채용(OB/YB)", condolence:"경조사", notice:"공지사항", research:"단행본 및 연구소개", suggest:"동문회에 바란다" };
    ...
    const TAGS_OB = {
      ...
      club: ["골프", "등산", "운영진", "기타"],
      mentoring: ["멘토 모집", "멘티 모집", "이달의 동문", "진로상담", "취업후기",
                  "만남의 광장", "유학", "운영관리", "기타"],
    ...
    const TAGS_YB = {
      mentoring: ["멘토 모집", "멘티 모집", "이달의 동문", "진로상담", "진학/취업 후기", "만남의 광장", "유학", "기타"],
      event: ["행사 안내", "참가 모집", "후기", "기타"],
      club: ["운영진", "축구", "농구", "스터디·분과회", "종교모임", "친목", "기타"],
