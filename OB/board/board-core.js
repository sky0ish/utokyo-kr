...
import { applyNav } from "/OB/board/nav.js?v=312";
import { boardInfo, boardTags, tagInfo } from "/OB/board/board-info.js?v=312";
...
async function drawAssembly(cat) {
  ...
  let mod = null;
  try { mod = await import("/OB/board/assembly-intro.js?v=312"); } catch (e) { return; }
