...
export async function initBoard(ORG) {
  ...
  const CAT_OB = { notice:"공지사항", free:"자유게시판", club:"소모임", mentoring:"멘토멘티(OB/YB)", promo:"홍보·채용", condolence:"경조사",
                   ...
                   research:"단행본 및 연구소개",
                   suggest:"동문회에 바란다" };
  const CAT_YB = { notice:"공지사항", free:"자유게시판", qna:"Q&A", jobs:"구인/채용", market:"벼룩시장",
  ...
  const TABS_YB = ["notice","free","qna","jobs","scholarship","market","exam"];   // 소모임·행사·멘토멘티·바란다는 참여마당에서 들어옵니다
