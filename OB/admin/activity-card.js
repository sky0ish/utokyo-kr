// [안 씀] 이 파일은 아무도 부르지 않습니다.
//   실제로 도는 코드는 admin/members.html 안에 그대로 들어 있습니다.
//   여기를 고쳐도 화면은 바뀌지 않으니 members.html 을 고치십시오.
// ─── 활동 통계 칸 ────────────────────────────────────────────
...
const CSS = `  /* 로그인 통계 */
  .actcard{margin-top:14px;background:#fff;border:1px solid #e6dfcb;border-radius:10px;padding:22px 24px;}
  .actcard .sh{display:flex;align-items:center;gap:12px;flex-wrap:wrap;margin-bottom:6px;}
  .actcard .sh h2{font-size:16px;font-weight:500;color:#4a3c14;}
  ...
  .actcard .seg a.on{background:#c9a961;color:#2b2410;}
  .actcard .cap{font-size:12.5px;color:#7d7768;margin-left:auto;}
  .actcard .chart{margin-top:10px;overflow-x:auto;}
  .actcard svg{display:block;}
  .actcard .legend{display:flex;gap:16px;flex-wrap:wrap;margin-top:8px;font-size:12.5px;color:#7d7768;}
  ...
  .actcard .ac-wbox h3{font-size:14px;font-weight:500;color:#4a3c14;margin-bottom:2px;}
  .actcard .ac-wbox p{font-size:12.5px;color:#7d7768;margin-bottom:10px;}
  .actcard .ac-wrow{display:flex;gap:10px;flex-wrap:wrap;align-items:center;}
  .actcard .ac-wrow label{display:flex;align-items:center;gap:6px;font-size:13px;color:#4a3c14;
    background:#fff;border:1px solid #ddd6c4;border-radius:8px;padding:6px 10px;}
  .actcard .ac-wrow input{width:56px;padding:5px 7px;border:1px solid #ddd6c4;border-radius:6px;
  ...
  .actcard .ac-top h4{font-size:13px;font-weight:600;color:#4a3c14;margin-bottom:8px;}
  ...
  .actcard .ac-top li:nth-child(odd){background:#fdf6e6;}
  ...
  .actcard .ac-top li .bar{flex:0 0 44px;height:5px;border-radius:3px;background:#efe9db;overflow:hidden;}
  .actcard .ac-top li .bar i{display:block;height:100%;background:#c9a961;}
  ...
  .actcard .ac-top h4 .clr:hover{color:#8a6d2b;}

  /* 연도 고르기 — 월별/연별과 다른 빛깔 */
  .actcard .ac-seg-year{border-color:#b6c2d6;}
  .actcard .ac-seg-year a{color:#4a5568;border-right-color:#b6c2d6;}
  .actcard .ac-seg-year a:hover{background:#eef2f8;color:#22304d;}
  .actcard .ac-seg-year a.on{background:#2a3f66;color:#fff;}

  .actcard .ac-seg-org{border-color:#d9cfae;}
  .actcard .ac-seg-org a{color:#7d7768;border-right-color:#d9cfae;}
  .actcard .ac-seg-org a:hover{background:#fdf6e6;color:#8a6d2b;}
  .actcard .ac-seg-org a.on{background:#8a6d2b;color:#fff;}`;
