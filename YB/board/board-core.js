...
import { applyNav } from "/YB/board/nav.js?v=312";
import { boardInfo, boardTags, tagInfo } from "/YB/board/board-info.js?v=312";
import { loadLikes, toggleLike, heart } from "/YB/auth/likes.js?v=312";
