...
import { applyNav } from "/YB/board/nav.js?v=315";
import { boardInfo, boardTags, tagInfo } from "/YB/board/board-info.js?v=315";
import { loadLikes, toggleLike, heart } from "/YB/auth/likes.js?v=315";
