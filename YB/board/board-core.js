...
import { applyNav } from "/YB/board/nav.js?v=316";
import { boardInfo, boardTags, tagInfo } from "/YB/board/board-info.js?v=316";
import { loadLikes, toggleLike, heart } from "/YB/auth/likes.js?v=316";
